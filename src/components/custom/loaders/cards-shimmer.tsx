...
export default function ShimmerCard({ 
  ...
  return (
    <div className={`bg-white dark:bg-transparent rounded-xl border border-gray-200 dark:bg-gray-700 p-6 shadow-sm ${className}`}>
      {/* Icon */}
      <div className={`${shimmerClass} w-12 h-12 rounded-full mb-4`}></div>
...
export function MetricCardsShimmer() {
  return (
    <div
      className={cn(
